...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   let arraySuma = 0;
   arrayOfNums.forEach(num=> arraySuma+=num);
   return arraySuma;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   let arraySuma = 0;
   resultadosTest.forEach(num=> arraySuma+=num);
   
   let arrayPromedio = arraySuma / resultadosTest.length;
...
function cuentoElementos(array) {
   ...
   // Tu código:
   let mayorQue18 = array.filter(x=> x>19);
...
return (numChar.charAt(0) === '9') ? true : false;
}
...
function todosIguales(array) {
   ...
   //const equal = (currentValue) => currentValue === array[0];
   const equal = (currentValue) => currentValue === array[0];
...
function mesesDelAño(array) {
   ...
   // Tu código: 
   let mesesReq = ["Enero", "Marzo", "Noviembre"];
   let mesesFound = [];
for(i = 0 ; i < array.length ; i++){
if (mesesReq.includes(array[i])){
   mesesFound.push(array[i]);
   }
}
if (mesesReq.length === mesesFound.length){
   return mesesFound;  
} 
